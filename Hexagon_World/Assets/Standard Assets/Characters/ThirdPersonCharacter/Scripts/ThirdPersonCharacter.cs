...
[RequireComponent(typeof(Rigidbody))]
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
		...
		[SerializeField] float strength_air_move = 6f;
		...
		void ScaleCapsuleForCrouching(bool crouch)
		{
			...
			else
			{
				...
				if (Physics.SphereCast(crouchRay, m_Capsule.radius * k_Half, 
					crouchRayLength, Physics.AllLayers,
	...
	// don't use that while airborne
		...
		{
			Vector3 airMove = new Vector3(Input.GetAxis("Horizontal") * strength_air_move, m_Rigidbody.velocity.y, 
			Input.GetAxis("Vertical")* strength_air_move);
